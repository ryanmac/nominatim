...
COPY ../nominatim-data/${PBF_PATH} /srv/nominatim/src/data.osm.pbf
COPY ../nominatim-data/wikipedia_article.sql.bin /srv/nominatim/src/wikipedia_article.sql.bin
COPY ../nominatim-data/wikipedia_redirect.sql.bin /srv/nominatim/src/wikipedia_redirect.sql.bin
COPY ../nominatim-data/gb_postcode_data.sql.gz /srv/nominatim/src/gb_postcode_data.sql.gz
